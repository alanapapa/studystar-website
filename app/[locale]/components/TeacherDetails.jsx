                            ...
                            <div className="relative px-8">
                                ...
                                <blockquote className="mt-8">
                                    <div className="relative text-lg font-medium text-white md:flex-grow">
                                        <svg
                                            className="absolute top-0 left-0 h-8 w-8 -translate-x-3 -translate-y-2 transform text-yellow-400"
                                            fill="currentColor"
                                            viewBox="0 0 32 32"
                                            aria-hidden="true"
                                        >
                                    ...
                                    <footer className="mt-4">
                                        <p className="text-base font-semibold text-rose-200">
                                            Муханова Гулжазира Абдугаппаровна,
                ...
                <div className="relative mx-auto max-w-md px-6 sm:max-w-3xl lg:px-0">
                    ...
                    <div className="mt-10">
                        ...
                        <div className="mt-10">
                            <a
                                href="#"
                                className="text-base font-medium text-cyan-500"
                            >
