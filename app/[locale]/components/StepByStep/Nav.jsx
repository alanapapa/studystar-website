...
const sections = [
    ...
    { id: 'second', title: 'Участие' },
    { id: 'third', title: 'Академия Судей' },
    { id: 'fourth', title: 'Национальная Премия' },
    { id: 'fifth', title: 'Глобальная Премия' },
]
...
export function Nav() {
    ...
    return (
        <div ref={navBarRef} className="sticky top-2 z-30">
                        ...
                        >
                            {!open && (
                                <>
                                    <span
                                        aria-hidden="true"
                                        className="font-mono text-sm text-[#00AFCA]"
                                    >
                                        {(mobileActiveIndex + 1)
                                            .toString()
                                            .padStart(2, '0')}
                            ...
                            <Link
                                ...
                                className={clsx(
                                    ...
                                    sectionIndex === activeIndex
                                        ? 'border-[#00AFCA] bg-blue-50 text-[#00AFCA] before:text-[#00AFCA]'
