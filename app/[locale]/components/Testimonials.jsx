...
import avatarImage6 from 'public/avatars/avatar-6.png'
import avatarImage7 from 'public/avatars/avatar-7.png'
import avatarImage8 from 'public/avatars/avatar-8.png'
import avatarImage9 from 'public/avatars/avatar-9.png'
import avatarImage10 from 'public/avatars/avatar-10.png'
import avatarImage11 from 'public/avatars/avatar-11.png'
        ...
        <section className="py-8 sm:py-10 lg:py-16">
            <Container className="text-center">
                ...
                <p className="mt-4 text-lg tracking-tight text-slate-600">
                    I worked with a small group of early access customers to
                    make sure all of the content in the book was exactly what
                    they needed. Hears what they had to say about the finished
                    product.
                </p>
            </Container>
            <Expandable>
